...
export default function ChatMessages({ mgsStyles, setMgsStyles, mgsEndRef }) {
    ...
    return (
        <main
            className={`${styles.mgsContainer}${mgsStyles.mgsOverlay ? ' ' + styles.mgsOverlay : ''}`}
            style={{
                ...
                >
                    ...
                    <div className={styles.mgsWrapper}>
                        {[
                            ...
                            return <ChatMgsItem key={index} mgsInfo={mgsInfo} />;
                        })}
                    </div>
                    <div ref={mgsEndRef} />
                </div>
